...
<!--END OF HEADER-->
  ...
  <section id="farm-sites" class="farm-sites">
      <div class="container">
      <h6 class="text-center heading font-x2">Agriceft</h6>
        <div class="row">

          <div class="col-lg-3" data-aos="fade-up">
            <a href="agriceft/gemadero.php">
            <div class="box">
