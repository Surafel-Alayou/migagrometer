...
<!--END OF HEADER-->
 ...
 <div class="container-xxl pb-5">
            <div class="container">
                <h6 class="text-center heading font-x2">Chefa</h6>
                                ...
                                <div class="row g-4">
                                    <div class="col-sm-12 col-md-8 d-flex align-items-center">
                                        <div class="text-start">
                                            <h5 class="mb-3"><i class="fa fa-map-marker-alt me-2"></i>Chefa</h5>
                                            <a href="sub-sites/chefa/chefa/daily.php"><i class="fa fa-external-link me-2"></i>Daily Precipitation Data</a><br>
                                            <a href="sub-sites/chefa/chefa/monthly.php"><i class="fa fa-external-link me-2"></i>Monthly Precipitation Data</a><br>
                                            <a href="sub-sites/chefa/chefa/yearly.php"><i class="fa fa-external-link me-2"></i>Yearly Precipitation Data</a>
                                        </div>
                                    </div>
                                    <div class="col-sm-12 col-md-4 d-flex flex-column align-items-start align-items-md-end justify-content-center">
                                        <div class="d-flex mb-3">
                                            <a class="btn btn-primary" href="sub-sites/chefa/chefa/insert-data.php">Insert Data</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
