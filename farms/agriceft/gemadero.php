...
<!--END OF HEADER-->
 ...
 <div class="container-xxl pb-5">
            <div class="container">
                <h6 class="text-center heading font-x2">Gemadero</h6>
                                ...
                                <div class="row g-4">
                                    <div class="col-sm-12 col-md-8 d-flex align-items-center">
                                        <div class="text-start">
                                            ...
                                            <a href="sub-sites/gumadero/unit-01/daily.php"><i class="fa fa-external-link me-2"></i>Daily Precipitation Data</a><br>
                                            <a href="sub-sites/gumadero/unit-01/monthly.php"><i class="fa fa-external-link me-2"></i>Monthly Precipitation Data</a><br>
                                            <a href="sub-sites/gumadero/unit-01/yearly.php"><i class="fa fa-external-link me-2"></i>Yearly Precipitation Data</a>
                                        </div>
                                    </div>
                                    <div class="col-sm-12 col-md-4 d-flex flex-column align-items-start align-items-md-end justify-content-center">
                                        <div class="d-flex mb-3">
                                            <a class="btn btn-primary" href="sub-sites/gumadero/unit-01/insert-data.php">Insert Data</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row g-4">
                                    <div class="col-sm-12 col-md-8 d-flex align-items-center">
                                        <div class="text-start">
                                            ...
                                            <a href="sub-sites/gumadero/unit-02/daily.php"><i class="fa fa-external-link me-2"></i>Daily Precipitation Data</a><br>
                                            <a href="sub-sites/gumadero/unit-02/monthly.php"><i class="fa fa-external-link me-2"></i>Monthly Precipitation Data</a><br>
                                            <a href="sub-sites/gumadero/unit-02/yearly.php"><i class="fa fa-external-link me-2"></i>Yearly Precipitation Data</a>
                                        </div>
                                    </div>
                                    <div class="col-sm-12 col-md-4 d-flex flex-column align-items-start align-items-md-end justify-content-center">
                                        <div class="d-flex mb-3">
                                        <a class="btn btn-primary" href="sub-sites/gumadero/unit-02/insert-data.php">Insert Data</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row g-4">
                                    <div class="col-sm-12 col-md-8 d-flex align-items-center">
                                        <div class="text-start">
                                            ...
                                            <a href="sub-sites/gumadero/unit-03/daily.php"><i class="fa fa-external-link me-2"></i>Daily Precipitation Data</a><br>
                                            <a href="sub-sites/gumadero/unit-03/monthly.php"><i class="fa fa-external-link me-2"></i>Monthly Precipitation Data</a><br>
                                            <a href="sub-sites/gumadero/unit-03/yearly.php"><i class="fa fa-external-link me-2"></i>Yearly Precipitation Data</a>
                                        </div>
                                    </div>
                                    <div class="col-sm-12 col-md-4 d-flex flex-column align-items-start align-items-md-end justify-content-center">
                                        <div class="d-flex mb-3">
                                        <a class="btn btn-primary" href="sub-sites/gumadero/unit-03/insert-data.php">Insert Data</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row g-4">
                                    <div class="col-sm-12 col-md-8 d-flex align-items-center">
                                        <div class="text-start">
                                            ...
                                            <a href="sub-sites/gumadero/unit-04/daily.php"><i class="fa fa-external-link me-2"></i>Daily Precipitation Data</a><br>
                                            <a href="sub-sites/gumadero/unit-04/monthly.php"><i class="fa fa-external-link me-2"></i>Monthly Precipitation Data</a><br>
                                            <a href="sub-sites/gumadero/unit-04/yearly.php"><i class="fa fa-external-link me-2"></i>Yearly Precipitation Data</a>
                                        </div>
                                    </div>
                                    <div class="col-sm-12 col-md-4 d-flex flex-column align-items-start align-items-md-end justify-content-center">
                                        <div class="d-flex mb-3">
                                        <a class="btn btn-primary" href="sub-sites/gumadero/unit-04/insert-data.php">Insert Data</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
