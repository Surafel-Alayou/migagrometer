...
if ($result_check_admin->num_rows > 0) {
    ...
    if ($result_check_permission->num_rows > 0) {
        ...
        if ($row['Allowed_farm'] === 'agriceft_gumero_unit_03') {
...
if ($allowed_to_submit && isset($_POST['submit'])) {
    ...
    if (!empty($date) && !empty($farm) && !empty($precipitation)) {
        ...
        $sql_check = "SELECT * FROM agriceft_gumero_unit_03 WHERE Record_date = ? AND Farm_name = ?";
        ...
        if ($result_check->num_rows > 0) {
            ...
            $sql_update = "UPDATE agriceft_gumero_unit_03 SET Precipitation = ?, Additional_information = ? WHERE Record_date = ? AND Farm_name = ?";
            ...
            $sql_insert = "INSERT INTO agriceft_gumero_unit_03 (Record_date, Farm_name, Precipitation, Additional_information) 
                           VALUES (?, ?, ?, ?)";
                ...
                <div class="col-lg-6 col-md-6">
                    ...
                    <form action="" method="post">
                        ...
                        <div>
                            ...
                            <input type="text" name="farm_name" required readonly value="agriceft_gumero_unit_03" placeholder="Agriceft-Beha">
                        </div>
                        <div>
