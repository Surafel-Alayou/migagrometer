...
<!--END OF HEADER-->
 ...
 <div class="container-xxl pb-5">
            <div class="container">
                <h6 class="text-center heading font-x2">Goma-1</h6>
                        ...
                        <div id="tab-1" class="tab-pane fade show p-0 active">
                                ...
                                <div class="row g-4">
                                    <div class="col-sm-12 col-md-8 d-flex align-items-center">
                                        <div class="text-start">
                                            <h5 class="mb-3"><i class="fa fa-map-marker-alt me-2"></i>05</h5>
                                            <a href="sub-sites/goma-1/05/daily.php"><i class="fa fa-external-link me-2"></i>Daily Precipitation Data</a><br>
                                            <a href="sub-sites/goma-1/05/monthly.php"><i class="fa fa-external-link me-2"></i>Monthly Precipitation Data</a><br>
                                            <a href="sub-sites/goma-1/05/yearly.php"><i class="fa fa-external-link me-2"></i>Yearly Precipitation Data</a>
                                        </div>
                                    </div>
                                    <div class="col-sm-12 col-md-4 d-flex flex-column align-items-start align-items-md-end justify-content-center">
                                        <div class="d-flex mb-3">
                                            <a class="btn btn-primary" href="sub-sites/goma-1/05/insert-data.php">Insert Data</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="sub-sites p-4 mb-4">
                                <div class="row g-4">
                                    <div class="col-sm-12 col-md-8 d-flex align-items-center">
                                        <div class="text-start">
                                            <h5 class="mb-3"><i class="fa fa-map-marker-alt me-2"></i>MO</h5>
                                            <a href="sub-sites/goma-1/mo/daily.php"><i class="fa fa-external-link me-2"></i>Daily Precipitation Data</a><br>
                                            <a href="sub-sites/goma-1/mo/monthly.php"><i class="fa fa-external-link me-2"></i>Monthly Precipitation Data</a><br>
                                            <a href="sub-sites/goma-1/mo/yearly.php"><i class="fa fa-external-link me-2"></i>Yearly Precipitation Data</a>
                                        </div>
                                    </div>
                                    <div class="col-sm-12 col-md-4 d-flex flex-column align-items-start align-items-md-end justify-content-center">
                                        <div class="d-flex mb-3">
                                        <a class="btn btn-primary" href="sub-sites/goma-1/mo/insert-data.php">Insert Data</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
