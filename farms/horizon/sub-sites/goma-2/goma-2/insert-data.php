...
if ($result_check_admin->num_rows > 0) {
    ...
    if ($result_check_permission->num_rows > 0) {
        ...
        if ($row['Allowed_farm'] === 'horizon_goma_2') {
...
if ($allowed_to_submit && isset($_POST['submit'])) {
    ...
    if (!empty($date) && !empty($farm) && !empty($precipitation)) {
        ...
        $sql_check = "SELECT * FROM horizon_goma_2 WHERE Record_date = ? AND Farm_name = ?";
        ...
        if ($result_check->num_rows > 0) {
            ...
            $sql_update = "UPDATE horizon_goma_2 SET Precipitation = ?, Additional_information = ? WHERE Record_date = ? AND Farm_name = ?";
            ...
            $sql_insert = "INSERT INTO horizon_goma_2 (Record_date, Farm_name, Precipitation, Additional_information) 
                           VALUES (?, ?, ?, ?)";
                ...
                <div class="col-lg-6 col-md-6">
                    ...
                    <form action="" method="post">
                        ...
                        <div>
                            ...
                            <input type="text" name="farm_name" required readonly value="horizon_goma_2" placeholder="Agriceft-Beha">
                        </div>
                        <div>
